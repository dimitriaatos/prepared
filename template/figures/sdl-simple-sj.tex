\begin{tikzpicture}[auto, node distance=1.5cm]
	...
	\draw[draw=red, opacity=0.4, line width=1mm] (-2.7,1.7) rectangle ++(15,1.1);
	\draw[-, draw=blue, opacity=0.4, line width=1mm] (-2.5,1.9) -- (-1.3,1.9) -- (-1.3,0.2) -- (6.8,0.2) -- (6.8,1.9) -- (12,1.9) -- (12,2.5) -- (-2.5,2.5) -- (-2.5,1.9);
\end{tikzpicture}