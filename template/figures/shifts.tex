	...
	\foreach \lineIndex in {0, ..., \lineMax} {
			...
			\ifnum \fullStepsPerLine>0
				...
				\foreach \stepIndex in {0, ..., \fullStepsPerLineMax} {
						...
						\draw[-, thin] (\lineIndex*\tf+\stepIndex+1, 1+\linePosition) -- (\lineIndex*\tf+\stepIndex+1, \bracesOffesY+\linePosition);
						\draw[-, thin] (\lineIndex*\tf+\stepIndex, 1+\linePosition) -- (\lineIndex*\tf+\stepIndex, \bracesOffesY+\linePosition);
					}
			\fi
		}
