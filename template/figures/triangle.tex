...
\begin{tikzpicture}[yscale=1/2]
	...
	% braces
	\draw[-, decorate, decoration = {brace}, yshift=0.1cm] (0, 1) -- (\tf, 1) node[midway,yshift=0.4cm] {$T_F$};
	\draw[-, decorate, decoration = {brace}, yshift=-0.1cm] (1, 0) -- (0, 0) node[midway,yshift=-0.4cm] {$T_N$};
	% bricks
